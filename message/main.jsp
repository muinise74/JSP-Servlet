					...
					<section id="banner" class="major">
						<div class="inner">
							<header class="major">
								...
								<%
									if (member == null) {
										out.print("<h1>로그인 한 이메일를 출력해주세요</h1>");
									} else {
										out.print("<h1>"+member.getM_email()+"</h1>");
									}
								%>
							...
							<section id="two">
								<div class="inner">
									...
									<ul class="actions">
										...
										%>
										<li><a href="DeleteCon" class="button next scrolly">전체삭제하기</a></li>
									</ul>
								</div>
							</section>
								...
								<section>
									<div class="contact-method">
										...
										<!-- 로그인 한 사용자의 이메일을 출력하시오 -->
											<%
												if (member == null) {
													out.print("<span>로그인해주세요</span>");
												} else {
													out.print("<a href='#''>"+member.getM_email()+"</a>");
												}
											%>
									</div>
								</section>
										...
										<!-- 로그인 한 사용자의 전화번호를 출력하시오 -->
											<%
												if (member == null) {
													...
													out.print("<span>"+member.getM_tel()+"</span>");
												}
											%>
									</div>
								</section>
										...
										<!-- 로그인 한 사용자의 집주소를 출력하시오 -->
											<%
												if (member == null) {
													...
													out.print("<span>"+member.getM_address()+"</span>");
												}
											%>
									</div>
								</section>
